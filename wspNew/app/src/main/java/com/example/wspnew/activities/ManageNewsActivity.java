...
public class ManageNewsActivity extends AppCompatActivity {
                ...
                for(int j = 0; j < news.names().length(); j++) {
                    if(news.names().getString(j).equals("author")) {
                        ...
                        tmpValues.add(authorString);
                            ...
                            !news.names().getString(j).equals("comments")) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ManageNewsActivity.this, ManagerActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.app_bar_menu_manage_news, menu);
        return true;
    }
